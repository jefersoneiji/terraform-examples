import {
  ...
  id = "arn:aws:iam::288605833937:oidc-provider/app.terraform.io"
}
...
data "aws_iam_policy_document" "terraform_cloud_admin_assume_policy" {
  statement {
    ...
    condition {
      ...
      values   = ["organization:Udemy-Terraform-Workspaces:project:Default-Project:workspace:terraform-oidc:run_phase:*"]
    }
  }
}
